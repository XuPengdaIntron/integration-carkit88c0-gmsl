@page Firmware_commands_8181_ES Firmware commands for fw version 0.0.9-dr
...
| ***Finish_FW_Download*** | @ref IfxRfe_finishFwDownload | Finalize the firmware download and execute an application reset. |
| ***Finish_Ramp_Scenario*** | @ref IfxRfe_finishRampScenario_exp | Wait for sequencer to complete the sequencer program and, after this, drive the device into the Operation state. |
...
| ***Set_MMIC_Clock*** | @ref IfxRfe_setMmicClock | Enable the clock input. |
