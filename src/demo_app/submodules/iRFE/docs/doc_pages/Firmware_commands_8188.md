@page Firmware_commands_8188 Firmware commands for fw version 1.0.0-qsr.rc1
...
| ***Set_Clock_Output*** | @ref IfxRfe_setClockOutput_exp | Enable/Disable clock MCU and/or clock PHY output. Command is valid only after switching to external clock derived from XIN. |
...
| ***Write_Results*** | @ref IfxRfe_writeResults_exp |  |
